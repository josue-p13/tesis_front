...
const ESTADO_CONFIG: Record<string, { variant: BadgeProps["variant"]; label: string }> = {
  ...
  "VERIFICADA (BD por score)": { variant: "success", label: "Verificada (BD score)" },
  ...
  URL_NO_ACCESIBLE: { variant: "destructive", label: "URL no accesible" },
  NO_ENCONTRADA: { variant: "destructive", label: "No encontrada" },
